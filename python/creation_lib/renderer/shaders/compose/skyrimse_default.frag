#version 330
// Skyrim SE default fragment shader — spec-gloss model, no palette system.
// Same pipeline as FO4 but without greyscale-to-palette.
...
void main()
{
    ...
    // No greyscale-to-palette for Skyrim SE
    ...
    for (int i = 0; i < numPointLights; i++) {
        ...
        color += pointLightCol[i] * albedo * diff * atten * diffuseWeight;
